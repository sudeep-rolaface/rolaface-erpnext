...
def create_quotation():
    ...
    allowedCurrencies = ["ZMW", "USD", "ZRA", "GBP", "CNY", "EUR", "INR"]
    ...
    try:
        ...
        for item in items:
            ...
            item_total = (qty * rate) - discount + tax
        ...
        return send_response(status="success", message="Quotation created successfully", status_code=200)
