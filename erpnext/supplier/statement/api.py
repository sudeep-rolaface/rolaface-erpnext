...
def get_supplier_statement():
    ...
    try:
        supplier = frappe.get_doc("Supplier", {"custom_supplier_id": supplier_id})
    ...
    for row in paginated_gl:
        ...
        if voucher_type == "Purchase Invoice":
            note = frappe.db.get_value("Purchase Invoice", voucher_no, "remarks") or ""
